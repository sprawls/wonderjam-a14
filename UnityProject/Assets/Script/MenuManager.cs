...
public class MenuManager : MonoBehaviour {
	...
	void OnGUI () {
        ...
        curWidth = 350;
        curHeight = 60;
		if (GUI.Button(new Rect(((Swidth - curWidth) / 2.0f), ((Sheight - curHeight) / 2.0f) + 250, curWidth, curHeight), "GO! [Entree]", skinMenu.GetStyle("Start button")))
		{
            StartGame();
        }
